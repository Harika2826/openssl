...
///// OQS_TEMPLATE_FRAGMENT_LIST_SIG_SWITCH_CASES_START
    ...
    case EVP_PKEY_P384_SPHINCSSHA2192SSIMPLE:
    case EVP_PKEY_SPHINCSSHA2256FSIMPLE:
    case EVP_PKEY_P521_SPHINCSSHA2256FSIMPLE:
    case EVP_PKEY_SPHINCSSHA2256SSIMPLE:
    case EVP_PKEY_P521_SPHINCSSHA2256SSIMPLE:
    ...
    case EVP_PKEY_P256_SPHINCSSHAKE128SSIMPLE:
    case EVP_PKEY_RSA3072_SPHINCSSHAKE128SSIMPLE:
    case EVP_PKEY_SPHINCSSHAKE192FSIMPLE:
    case EVP_PKEY_P384_SPHINCSSHAKE192FSIMPLE:
    case EVP_PKEY_SPHINCSSHAKE192SSIMPLE:
    case EVP_PKEY_P384_SPHINCSSHAKE192SSIMPLE:
    case EVP_PKEY_SPHINCSSHAKE256FSIMPLE:
    case EVP_PKEY_P521_SPHINCSSHAKE256FSIMPLE:
    case EVP_PKEY_SPHINCSSHAKE256SSIMPLE:
    case EVP_PKEY_P521_SPHINCSSHAKE256SSIMPLE:
